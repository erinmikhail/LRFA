...
int find_next_office(const PostSystem *system, int current_office_id, int target_office_id);
...
int load_mappings_from_file(PostSystem *system, const char *filename);
#endif
